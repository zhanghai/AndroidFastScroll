...
[Sample APK](//github.com/zhanghai/AndroidFastScroll/releases/download/v1.0.2/sample-release.apk)
...
```gradle
implementation 'me.zhanghai.android.fastscroll:library:1.0.2'
```
